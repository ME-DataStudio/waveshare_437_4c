// Created from example for library:
// https://github.com/Bodmer/TJpg_Decoder

// The original example is for an ESP8266 or ESP32, it fetches a Jpeg file
// from the web and saves it in a SPIFFS file. You must have SPIFFS
// space allocated in the IDE.

// Example adjusted for use with waveshare 4.37 inch 4 colour display
// Driver ised: GxEPD2 library
...
{
  Serial.begin(115200);
  Serial.println("\n\n Testing TJpg and GxEPD2 libraries");
